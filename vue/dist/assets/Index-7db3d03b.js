...
`;Q(W);z.render=J;const X={components:{ConfirmPopup:z},data(){return{search:"",headers:[],children:[],alert_text:null,loading:!0}},computed:{header(){return this.headers=[{key:"id",title:this.$t("index")},{key:"name",title:this.$t("child_name")},{key:"birth_date",title:this.$t("birth_date")},{key:"actions",title:this.$t("actions")}]}},methods:{getChildren(){O.get("/api/child").then(e=>{this.children=e.data.children,console.log(e.data.children),this.loading=!1})},fomate(e){return Z(e).format("DD-MM-yy ")},editItem(e){this.$router.push({name:"EditChildren",params:{id:e}})},deleteItem(e){console.log(e),O.delete(`/api/child/${e}/delete`).then(n=>{n.data.status==200&&(this.alert_text="children deleted successfully ",this.children=n.data.children)})},showItem(e){this.$router.push({name:"ShowChildren",params:{id:e}})},create(){this.$router.push({name:"CreateChildren"})}},async mounted(){this.$route.params.alert&&(this.alert_text="done "),this.getChildren()}};function ee(e,n,d,u,i,t){const g=C("Button"),k=C("v-data-table");return a(),y("div",null,[i.alert_text!=null?(a(),b(F,{key:0,type:"success",variant:"tonal",border:"start",elevation:"2",closable:"","close-label":e.$t("close"),text:i.alert_text,class:"mb-8"},null,8,["close-label","text"])):L("",!0),s(R,{text:"Create",color:"green",height:"45",class:"mb-5 mt-5",onClick:t.create},{default:r(()=>[h(m(e.$t("create_button")),1)]),_:1},8,["onClick"]),s($,null,{default:r(()=>[s(Y,null,{default:r(()=>[h(m(e.$t("children"))+" ",1),s(_),s(D,{modelValue:i.search,"onUpdate:modelValue":n[0]||(n[0]=l=>i.search=l),"append-icon":"mdi-magnify",label:"Search","single-line":"","hide-details":""},null,8,["modelValue"])]),_:1}),s(k,{headers:t.header,items:i.children,search:i.search},{top:r(()=>[i.loading?(a(),b(x,{key:0,slot:"progress",style:{color:"#135c65"},indeterminate:""})):L("",!0)]),item:r(({item:l})=>[c("tr",null,[c("td",null,m(l.columns.id),1),c("td",null,m(l.columns.name),1),c("td",null,m(t.fomate(l.columns.birth_date)),1),c("td",null,[s(j,{small:"",color:"primary",class:"mr-2",onClick:o=>t.showItem(l.columns.id)},{default:r(()=>[h("mdi-eye")]),_:2},1032,["onClick"]),s(j,{small:"",color:"primary",class:"mr-2",onClick:o=>t.editItem(l.columns.id)},{default:r(()=>[h("mdi-pencil")]),_:2},1032,["onClick"]),s(j,{small:"",color:"error",onClick:o=>t.deleteItem(l.columns.id)},{default:r(()=>[h("mdi-delete")]),_:2},1032,["onClick"]),s(g,{onClick:n[1]||(n[1]=o=>e.confirm2(o)),icon:"pi pi-times",label:"Delete",outlined:"",severity:"danger"})])])]),_:1},8,["headers","items","search"])]),_:1})])}const ce=H(X,[["render",ee]]);export{ce as default};
