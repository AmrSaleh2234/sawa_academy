    ...
    <v-row>
      ...
      <v-col cols="4">
        ...
        >
          ...
          />
          <label for="" style=" font-size: 20px;font;">Site Cover</label>
          <img
            src="@/assets/img/112.png"
            alt=""
            class="rounded-lg object-cover"
    ...
    updateSettings() {
      axios
        .post("/api/site/settings", {
          ...
          number_1: this.settings.number_1,
          number_2: this.settings.number_2,
          address: this.settings.address,
          email: this.settings.email,
          description: this.settings.description,
          social_links: JSON.stringify({ links: this.settings.social_links }),
        })
        .then((res) => {
          console.log(res);
        })
