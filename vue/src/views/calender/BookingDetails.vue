<template>
  <div class="mt-6">
    ...
    <div class="flex flex-col md:flex-row md:justify-between w-full mt-4 py-2">
      <!-- Left Side -->
      <div
        class="w-1/4 bg-gray-100 rounded-xl text-right pb-6 md:pb-0 px-6 mx-6 self-start"
      >
        <div
        ...
        >
          ...
          <p class="flex flex-col text-center py-2">
            ...
            <span style="color: #00897b">اخصائي مخ واعصاب</span>
          </p>
        </div>
        <div>
          <p class="py-2">
            <span>
              <span style="color: #00897b">12 pm sat</span>
              : موعد الاستشارة
            </span>
          </p>
      ...
      >
        <div class="w-1/2 p-6 bg-white rounded-md shadow-xl">
          ...
          <div class="mt-4 text-right">
            <p class="border-b-2 my-9 py-2 border-black">
              <span class="">
                <span style="color: #00897b">{{ booking.child_gender }}</span>
                : الجنس
              </span>
            </p>
            <p class="border-b-2 my-9 py-2 border-black">
              <span class="">
                <span style="color: #00897b">{{ booking.child_problem }}</span>
                : نرجو تحديد نوع المشكله
              </span>
              <span class="block">
                <span class="text-sm">{{ booking.child_problems_notes }}</span>
              </span>
            </p>
            <p class="border-b-2 my-9 py-2 border-black">
              <span class="">
                <span style="color: #00897b">{{ booking.child_aids }}</span>
                : هل يستخدم الطفل اي معينات حركيه / سمعيه/ بصريه
              </span>
              <span class="block">
                <span class="text-sm">{{ booking.child_aids_notes }}</span>
              </span>
            </p>
            <p class="border-b-2 my-9 py-2 border-black">
              <span class="">
                <span style="color: #00897b">{{
                  booking.child_parents_problems
                }}</span>
