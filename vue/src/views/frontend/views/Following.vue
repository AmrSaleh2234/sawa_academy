<template>
    <div class="">
      ...
      <div class=" flex justify-between border-b-2 p-2 border-x-cyan-950 border-solid ">
        ...
        <div><p class=" text-center m-auto col-span-2 px-2 py-4 text-xl text-[#6EB7BF]" >الملف الشخصي</p></div>
        <div class="text-left m-auto">
            <button class=" ">
                <router-link  class=" flex" to="/">
                    <p class="md:pt-4 py-2 md:text-2xl ">الرئيسيه</p>
                    <font-awesome-icon class="bg-[#135C65] rounded-[50%] m-2 md:p-4 p-2" icon="fa-solid fa-arrow-left" />
                </router-link>
            </button>
        </div>
      </div>
        <div class="relative overflow-clip max-w-full  max-h-screen flex">
            ...
            <div class=" flex-1 min-h-screen overflow-scroll ">
                <div class="top-0 bg-white absolute text-2xl w-full text-[#6EB7BF] p-2 text-center shadow ">متابعه الطفل</div>
                <according class="text-xs block" name="محمد عماد محمد الشيخ" age="15" >
                 ...
                 <div class="w-full py-4 text-center"><button>اضافه طفل جديد<font-awesome-icon class="text-lg text-[#48A700] " icon="fa-solid fa-plus" /></button></div>
            </div>
