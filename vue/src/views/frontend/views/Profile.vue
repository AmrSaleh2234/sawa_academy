    ...
    <div class="relative flex selection max-h-full">
      ...
      <div class="flex-1 space-y-10">
        <div class="bg-white text-2xl text-[#6EB7BF] pt-6 text-center">
          <button>{{$t("Modify_profile")}}</button>
        </div>
        <div class="p-2">
          <div class="block max-w-lg m-auto shadow-lg p-[2%] rounded-lg space-y-6 bg-white">
            <div class="relative m-auto ">
              <input type="file" ref="fileInput" style="display: none;" @change="handleFileUpload"/>
              <img @click="openFileUpload" :src="imageSrc"
                   class="uploaded-image relative m-auto cursor-pointer  rounded-full">
              <svg @click="openFileUpload"
                   class=" cursor-pointer absolute left-[50%] m-auto  bottom-0 bg-white rounded-full p-1   h-8 w-8"
                   viewBox="-2.4 -2.4 28.80 28.80" xmlns="http://www.w3.org/2000/svg" fill="#29CCFF"
            ...
            >
             ...
             <div class="m-auto">
              <svg class="m-auto" xmlns="http://www.w3.org/2000/svg" width="65" height="5" viewBox="0 0 65 5">
                <line id="Line_16" data-name="Line 16" x2="60" transform="translate(2.5 2.5)" fill="none" stroke="#7a7a7a" stroke-linecap="round" stroke-width="5"/>
              </svg>
             </div>
