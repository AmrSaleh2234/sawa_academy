        ...
        <div class="relative  flex ">
            ...
            <div class="flex-1 space-y-10  ">
                ...
                <div class="p-2 ">
                    ...
                    <div class="block max-w-lg m-auto rounded-lg space-y-6 bg-white py-8">
                        <div class="relative m-auto " >
                            <input type="file" ref="fileInput" style="display: none;" @change="handleFileUpload" />
                            <img  @click="openFileUpload" :src="imageSrc" class="uploaded-image relative m-auto cursor-pointer  rounded-full" >
                            <svg @click="openFileUpload" class=" cursor-pointer absolute left-[50%] m-auto  bottom-0 bg-white rounded-full p-1   h-8 w-8"  viewBox="-2.4 -2.4 28.80 28.80" xmlns="http://www.w3.org/2000/svg" fill="#29CCFF" transform="matrix(-1, 0, 0, 1, 0, 0)"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill="#29CCFF" d="M21 3H3C1.35 3 0 4.35 0 6v12c0 1.55 1.19 2.83 2.7 2.98.1.01.2.02.3.02h18c.1 0 .2 0 .29-.02.03 0 .06-.01.09-.01C22.86 20.78 24 19.52 24 18V6c0-1.65-1.35-3-3-3zm1 13.53l-2.21-4.42c-.25-.5-.69-.87-1.22-1.03-.19-.05-.38-.08-.57-.08-.35 0-.7.09-1.01.27l-6.41 3.74-2.46-1.67C7.78 13.11 7.39 13 7 13c-.52 0-1.03.2-1.41.59L2 17.18V6c0-.55.45-1 1-1h18c.55 0 1 .45 1 1v10.53z"></path> <circle fill="#29CCFF" cx="11" cy="10" r="2"></circle> </g></svg>
                        </div>
                        ...
                        <div style="font-size:16px" class="flex"><p class=" m-auto text-center text-[#FF3765]">تنبيه هام : برجاء اختيار حجم الصوره 440 بسكل * 660 بسكيل</p>
                            <div class="px-1 card m-auto flex justify-content-center">
                                <Knob text-color="#FFD02B" rangeColor="white" valueColor="#FFD02B" :strokeWidth="5" :size="50" class=" m-auto" v-model="value" />
                            </div>
                         </div>
                        ...
                        <form class=" space-y-10 text-center rounded-2xl  p-6 bg-[#F8F8F8]" action="#">
                            <div class="grid grid-cols-2">
                                <div  class=" m-auto ml-4 bg-[#F8F8F8] " style="display: flex; align-items: center;border-bottom:2px solid rgb(0, 0, 0) ">
                                    <input   style="font-size:20px" class="backdrop-blur-md bg-white/30  focus:ring-0  w-full p-2 text-center  border-0" type="email" v-model="last_name" >
                                  
                                </div> 
                                <div  class=" m-auto ml-4 bg-[#F8F8F8] " style="display: flex; align-items: center;border-bottom:2px solid rgb(0, 0, 0) ">
                                    <input  style="font-size:20px" class="backdrop-blur-md bg-white/30  focus:ring-0  w-full p-2 text-center  border-0" type="email" v-model="first_name" >
                            ...
                            <div class=" m-auto  bg-[#F8F8F8] " style="display: flex; align-items: center;border-bottom:2px solid rgb(0, 0, 0) ">
                                <input   style="font-size:18px" class="backdrop-blur-md bg-white/30  focus:ring-0  w-full p-2 text-center  border-0" type="email" v-model="email" >
                               
                            </div>
                            <div  class=" m-auto  bg-[#F8F8F8] " style="display: flex; align-items: center;border-bottom:2px solid rgb(0, 0, 0) ">
                                <input   style="font-size:18px" class="backdrop-blur-md bg-white/30  focus:ring-0  w-full p-2 text-center  border-0" type="password" v-model="password" >
                            </div>
...
.uploaded-image {
  width: 101px; 
  height:101px;/* Set the desired width for the image */
  /* You can also use percentage values or other valid CSS units for the width */
  /* Example: width: 100%; will make the image take the full width of its container */
}
</style>
