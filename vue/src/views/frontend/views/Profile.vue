<template>
  <div class="">
    ...
    >
      ...
      <div class="m-auto visible md:invisible" @click="toggle()">
        <font-awesome-icon
          class="text-3xl text-right text-black hover:text-red-600"
    ...
    <div class="relative flex min-h-screen">
      ...
      <div class="flex-1 space-y-10">
        ...
        <div class="p-2">
          <div class="block max-w-md m-auto rounded-lg space-y-6 bg-white">
            <div>
              <p class="text-center text-[#FF3765]">
                تنبيه هام : برجاء اختيار حجم الصوره 440 بسكل * 660 بسكيل
              </p>
            </div>

            <form
              class="space-y-6 text-center rounded-2xl p-4 bg-[#F8F8F8]"
              action="#"
            >
              <div class="grid grid-cols-2">
                <input
                  class="backdrop-blur-md bg-white/30 text-center border-b-2 border-black border-solid border-0 mx-4 p-2"
                  type="email"
                  name="email"
                  placeholder=" الاسم العائله"
                  required=""
                />
                <input
                  class="backdrop-blur-md bg-white/30 text-center border-b-2 border-black border-solid border-0 mx-4 p-2"
            ...
            <button
              class="p-2 text-center bg-[#148A98] text-white w-full rounded-2xl text-xl"
            >
              حفظ التغيرات
            </button>
          </div>
