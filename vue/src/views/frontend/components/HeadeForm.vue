<template>
  <div style="padding-top: 6%; padding-bottom: 6%;" class=" relative bg-center bg-cover max-h-screen">
    ...
    <div class="relative background-color lg:w-[50%] px-[5%] z-10">
      <h1 style="font-size: 35px" class="font-bold text-right pr-6 text-white">
        {{ $t("Sawa_Academy_for_Special_Education") }}
      </h1>
      <h2 style="font-size: 30px" class="text-3xl m-10 text-right text-white">
        {{ $t("Better_self_care_for_your_child_through_us") }}
      </h2>
      <div
        style="color: white"
        class="relative flex justify-between bg-black p-2 opacity-70 w-[90%] rounded-3xl"
      >
