...
<template>
  <Navbar class="flex flex-nowrap">
    ...
    <template  #default="{ isShowMenu }" >
      <NavbarCollapse :isShowMenu="isShowMenu" class="border-0">
        <li
  ...
  <nav class="bg-white p-2">
    <div class="container mx-auto flex items-center justify-between">
      ...
      <div class="hidden md:flex space-x-4">
        <li
        class="block text-2xl mr-6 m-auto cursor-pointer md-:p-0 text-[#125B64] font-bold hover:border-b-2 border-[#FF5C82]"
      >
        <router-link to="/"> التربيه الخاصه </router-link>
      </li>
      <li
        class="block text-2xl mr-6 m-auto cursor-pointer md-:p-0 text-[#125B64] font-bold hover:border-b-2 border-[#FF5C82]"
      >
      ...
      <li
        class="block text-2xl mr-6 m-auto cursor-pointer md-:p-0 text-[#125B64] font-bold hover:border-b-2 border-[#FF5C82]"
      >
        <router-link to="/more">ماذا عنا</router-link>
      </li>
      <li
        class="block text-2xl mr-6 m-auto cursor-pointer md-:p-0 text-[#125B64] font-bold hover:border-b-2 border-[#FF5C82]"
      >
        <router-link to="/ReAction"> الرئيسيه</router-link>
      </li>
      <div class="flex space-x-2">
        <div>
          <div class="relative">
