...
class SideprofileRepository
{
    ...
    {
        return sideProfile::selectRaw("side_profiles.title side_profile_title , evaluations.title evaluation_title , evaluations.side_profile_id  , evaluations.id evaluation_id")
